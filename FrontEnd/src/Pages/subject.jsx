...
import { subjectQuery, createSubject } from "../Queries/subjectQueries";
...
function Subject() {
  ...
  return (
    <main className="space-y-5 relative">
      ...
      {showCreate && (
        <div className="absolute top-0 bg-white shadow-lg w-full p-5 rounded-lg  bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 border-2 border-indigo-200">
